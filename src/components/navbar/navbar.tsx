...
import type { CreatePlaylistDialogProps } from '@pages/personal/components/create-playlist-dialog/create-playlist-dialog';
import { setTheme } from '@utils';
import { Scrollable } from 'rx-scrollable';
import { CustomButtonOutlined, DIconButton } from '@components/button';
      ...
      <div className="d-navbar flex items-center justify-center flex-1 sticky top-0 z-10" ref={navRef}>
        <div className="nav-leading flex items-center">
          <Link to="discovery" className="text-decoration-none back-home">
            <DIconButton shape="circle" siz="60px" className="action-button">
        ...
        <div className="main-actions flex items-center">
          <DIconButton onClick={() => setOpenDialog(true)} shape="circle" siz="60px" className="action-button">
